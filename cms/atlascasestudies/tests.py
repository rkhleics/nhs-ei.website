...
class TestAtlasCaseStudyIndexPage(TestCase):
    ...
    def test_case_study_list(self):
        ...
        self.assertEqual(case_list.select_one(
            'h2').text.strip(), 'Atlas Case Study One')
        self.assertEqual(case_list.select_one('h2 a')['href'],
        ...
        self.assertEqual(case_list.select_one(
            'p.nhsuk-body-s a:nth-of-type(2)').text.strip(), 'Setting One')
        self.assertEqual(case_list.select_one(
            'p.nhsuk-body-s a:nth-of-type(2)')['href'], '?setting=1')
