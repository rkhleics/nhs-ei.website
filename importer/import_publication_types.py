...
from nhsei_wagtail.categories.models import PublicationType, PublicationTypeSubSite
...
class PublicationTypesImporter(Importer):
    def __init__(self):
        ...
        if publication_type or publication_type_sub_sites:
            sys.stdout.write('⚠️  Run delete_publication_types before running this command\n')
            sys.exit()
    ...
    def parse_results(self):
        ...
        for r in publication_types:
            ...
            try:
                publication_type_sub_site = PublicationTypeSubSite.objects.get(source=r.get('source'))
