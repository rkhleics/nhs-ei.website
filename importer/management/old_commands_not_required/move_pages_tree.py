...
from nhsei_wagtail.pages.models import BasePage, ComponentsPage, LandingPage
...
class Command(BaseCommand):
    ...
    In the future there's going to need to be some adjusments Im sure but moving a smaller amount
    ...
    def handle(self, *args, **options):
        ...
        for page in pages:  # loop away
            ...
            if page.parent > 0:
                has_multiple_parents = BasePage.objects.filter(
                    wp_id=page.parent)
            ...
            #     # or can carry on
            #     print('carry on')
            #     move_to = BasePage.objects.filter(wp_id=page.parent)
            # elif page.parent == 0 and page.real_parent > 0:
