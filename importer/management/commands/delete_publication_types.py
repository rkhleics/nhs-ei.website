...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if publications:
            sys.stdout.write('⚠️ Please delete publications before running this commend\n') 
            sys.exit()
        ...
        if not publication_types.count():
            ...
            sys.stdout.write('Publication Types to delete: {}\n'.format(
                publication_types_length))
            ...
            sys.stdout.write('Publication Type Sub Sites to delete: {}\n'.format(
